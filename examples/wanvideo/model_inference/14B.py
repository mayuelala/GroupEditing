...
pipe = WanVideoPipeline.from_pretrained(
    ...
    device="cuda:0",
    model_configs=[
        ModelConfig(path="/root/wangxinyu/pretrained_models/alibaba-pai/Wan2.1-Fun-V1.1-14B-InP/diffusion_pytorch_model.safetensors", offload_device="cpu"),
        ModelConfig(path="/root/wangxinyu/pretrained_models/alibaba-pai/Wan2.1-Fun-V1.1-14B-InP/models_t5_umt5-xxl-enc-bf16.pth", offload_device="cpu"),
        ModelConfig(path="/root/wangxinyu/pretrained_models/alibaba-pai/Wan2.1-Fun-V1.1-14B-InP/Wan2.1_VAE.pth", offload_device="cpu"),
        ModelConfig(path="/root/wangxinyu/pretrained_models/alibaba-pai/Wan2.1-Fun-V1.1-14B-InP/models_clip_open-clip-xlm-roberta-large-vit-huge-14.pth", offload_device="cpu"),
    ],
)
...
result_root = "/root/wangxinyu/result"
...
for subdir in os.listdir(frames_root):
    ...
    for i in range(0, len(frame_files) - 1, 2):
        ...
        # 保存视频
        save_path = os.path.join(save_dir, f"14B-video_{idx}-{idx+1}.mp4")
